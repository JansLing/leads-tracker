...
A polished, demoable sales leads tracker with AI-powered lead scoring and status management, built to showcase full-stack shipping ability to recruiters.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "302160767+JansLing@users.noreply.github.com"
  git config user.name "JansLing"
  ```
